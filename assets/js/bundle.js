      ...
      function (e, t, n) {
        ...
        function r() {
          $(".header__toggle").click(function () {
            $(".header__links").is(".velocity-animating") ||
        ...
        (window.jQuery = window.$ = e("jquery")),
          e("velocity-animate/velocity.js"),
          e("lazysizes"),
          e("lazysizes/plugins/unveilhooks/ls.unveilhooks.js"),
            ...
            r(),
                ...
                $(window).scroll(function () {
                  if ($(window).width() >= 1024) {
                    if (!t.hasClass("fixed")) {
                      ...
                      r > n
                        ? (r > 636 &&
                            (t.hasClass("fix-nav") || t.addClass("fix-nav")),
                          i >= 6 &&
                            (r > e
                              ? t.hasClass("hide-nav") || t.addClass("hide-nav")
                              : t.hasClass("hide-nav") &&
                                $(t).removeClass("hide-nav")))
                        : r <= 0 &&
                          (t.removeClass("hide-nav show-nav"),
                          t.addClass("top"));
                    }
                    window.innerHeight + window.scrollY >=
                      document.body.offsetHeight && t.removeClass("hide-nav"),
                      (e = r);
              ...
              $(".js-submit").click(function (e) {
                ...
                for (var i = 0; i < t.length; i++) {
                  ...
                  $(o).attr("required", !0) &&
                    !a($(o).val()) &&
                    (s($(o), "This field is required"), (r = !0)),
                    $(o).attr("required", !0) &&
                      "email" === $(o).attr("type") &&
                      !(function (e) {
                        return (
                      ...
                      (s($(o), "Email address is invalid"), (r = !0)),
                    $(n).attr("required", !0) &&
                      !a($(n).val()) &&
                      (s($(n), "This field is required"), (r = !0));
                }
      ...
      function (e, t, n) {
        !(function (e, n) {
          ...
          function u(e, t, n, r) {
            var i;
            try {
              e && se.isFunction((i = e.promise))
                ? i.call(e).done(t).fail(n)
                : e && se.isFunction((i = e.then))
                ? i.call(e, t, n)
            ...
            return (
              (n =
                void 0 !== e.getElementsByTagName
                  ...
                  : []),
              void 0 === t || (t && i(e, t)) ? se.merge([e], n) : n
            );
          }
          function y(e, t) {
                ...
                if ("object" === se.type(o)) se.merge(d, o.nodeType ? [o] : o);
                  ...
                  for (
                    a = a || f.appendChild(t.createElement("div")),
                      ...
                      l = Re[s] || Re._default,
                      a.innerHTML = l[1] + se.htmlPrefilter(o) + l[2],
                      c = l[0];
                    c--;

                  )
                    a = a.lastChild;
                  se.merge(d, a.childNodes),
                    ((a = f.firstChild).textContent = "");
                } else d.push(t.createTextNode(o));
            for (f.textContent = "", p = 0; (o = d[p++]); )
              if (r && se.inArray(o, r) > -1) i && i.push(o);
              else if (
                ((u = se.contains(o.ownerDocument, o)),
          ...
          function E(e, t) {
            ...
            if (1 === t.nodeType) {
              ...
              Pe.hasData(e) &&
                ((s = Pe.access(e)), (l = se.extend({}, s)), Pe.set(t, l));
            }
          }
          function A(e, t) {
          ...
          function P(e, t, r, i) {
            ...
            if (
              g ||
              (d > 1 && "string" == typeof h && !ae.checkClone && Ye.test(h))
            )
            ...
            if (
              d &&
              ((o = v(t, e[0].ownerDocument, !1, e, i)),
              (a = o.firstChild),
              1 === o.childNodes.length && (o = a),
              a || i)
            ) {
              for (l = (s = se.map(m(o, "script"), S)).length; f < d; f++)
                (u = o),
                  f !== p &&
                    ((u = se.clone(u, !0, !0)),
                    l && se.merge(s, m(u, "script"))),
                  r.call(e[f], u, f);
              if (l)
                for (
                  c = s[s.length - 1].ownerDocument, se.map(s, k), f = 0;
                  f < l;
                  f++
                )
                  (u = s[f]),
                    $e.test(u.type || "") &&
                      ...
                      se.contains(c, u) &&
                      (u.src
                        ? se._evalUrl && se._evalUrl(u.src)
                        : n(u.textContent.replace(Qe, ""), c));
            }
            return e;
          }
          function N(e, t, n) {
            for (
              ...
              n || 1 !== r.nodeType || se.cleanData(m(r)),
                r.parentNode &&
                  (n && se.contains(r.ownerDocument, r) && y(m(r, "script")),
          ...
          function D(e, t, n, r, i) {
            ...
            for (
              ...
              "margin" === n && (a += se.css(e, n + Fe[o], !0, i)),
                r
                  ? ("content" === n &&
                      (a -= se.css(e, "padding" + Fe[o], !0, i)),
                    "margin" !== n &&
                      (a -= se.css(e, "border" + Fe[o] + "Width", !0, i)))
                  : ((a += se.css(e, "padding" + Fe[o], !0, i)),
                    "padding" !== n &&
                      (a += se.css(e, "border" + Fe[o] + "Width", !0, i)));
            return a;
          ...
          function H(e, t, n) {
            ...
            return Ze.test(o)
              ? o
              : ((r = a && (ae.boxSizingReliable() || o === e.style[t])),
                "auto" === o &&
                  (o = e["offset" + t[0].toUpperCase() + t.slice(1)]),
                (o = parseFloat(o) || 0) +
                  D(e, t, n || (a ? "border" : "content"), r, i) +
                  "px");
          }
          ...
          function M(e, t, n) {
            ...
            for (
              ...
              if ((r = M.prefilters[o].call(u, e, c, u.opts)))
                return (
                  se.isFunction(r.stop) &&
                    (se._queueHooks(u.elem, u.opts.queue).stop = se.proxy(
                      r.stop,
                      r
                    )),
                  r
            ...
            return (
              se.map(c, R, u),
              se.isFunction(u.opts.start) && u.opts.start.call(e, u),
              u
          ...
          (se.fn = se.prototype = {
                  ...
                  for (t in e)
                    (n = a[t]),
                      a !== (r = e[t]) &&
                        (u &&
                        r &&
                        (se.isPlainObject(r) || (i = Array.isArray(r)))
                          ? (i
                              ? ((i = !1), (o = n && Array.isArray(n) ? n : []))
                              : (o = n && se.isPlainObject(n) ? n : {}),
                            (a[t] = se.extend(u, o, r)))
                          : void 0 !== r && (a[t] = r));
              return a;
            }),
            ...
            "function" == typeof Symbol &&
              (se.fn[Symbol.iterator] = Y[Symbol.iterator]),
            se.each(
          ...
          var de = (function (e) {
            function t(e, t, n, r) {
              ...
              if (
                !r &&
                ((t ? t.ownerDocument || t : $) !== L && j(t), (t = t || L), F)
              ) {
                if (11 !== h && (l = ge.exec(e)))
                  if ((i = l[1])) {
                    if (9 === h) {
              ...
              return (
                ...
                r(function (r, s, l, u) {
                  var c,
                    ...
                    b = i ? (a || (r ? e : g || o) ? [] : s) : v;
                  if ((i && i(v, b, l, u), o))
                    for (c = m(b, h), o(c, [], l, u), f = c.length; f--; )
                      (d = c[f]) && (b[h[f]] = !(v[h[f]] = d));
                  if (r) {
                    if (a || e) {
                      if (a) {
            ...
            try {
              Q.apply((U = J.call($.childNodes)), $.childNodes),
              ...
              (j = t.setDocument = function (e) {
                ...
                return r !== L && 9 === r.nodeType && r.documentElement
                  ? ((L = r),
                    ...
                    (H = []),
                    (D = []),
                    (x.qsa = he.test(L.querySelectorAll)) &&
                      (i(function (e) {
                      ...
                      ? function (e, t) {
                          ...
                          return (
                            ...
                            (!x.sortDetached &&
                              ...
                              ? e === L || (e.ownerDocument === $ && V($, e))
                                ? -1
                                : t === L || (t.ownerDocument === $ && V($, t))
                                ? 1
                                : P
                                ? Z(P, e) - Z(P, t)
                                : 0
            ...
            return (
              ...
              (k = t.compile = function (e, n) {
                var i,
                  ...
                  s = I[e + " "];
                if (!s) {
                  for (n || (n = S(e)), i = n.length; i--; )
                    (s = v(n[i]))[O] ? o.push(s) : a.push(s);
                  (s = I(
                    e,
                    (function (e, n) {
                      var i = n.length > 0,
              ...
              (E = t.select = function (e, t, n, r) {
                ...
                if (((n = n || []), 1 === c.length)) {
                  if (
                    ...
                    if (
                      !(t = (w.find.ID(a.matches[0].replace(ye, ve), t) ||
                        [])[0])
                    )
                      return n;
                    u && (t = t.parentNode),
              ...
              (x.sortStable = O.split("").sort(B).join("") === O),
          ...
          (se.find = de),
            ...
            (se.uniqueSort = se.unique = de.uniqueSort),
            (se.text = de.getText),
            (se.isXMLDoc = de.isXML),
            (se.contains = de.contains),
            (se.escapeSelector = de.escape);
          ...
          (se.filter = function (e, t, n) {
            ...
            se.fn.extend({
              ...
              is: function (e) {
                return !!o(
                  this,
                  "string" == typeof e && ge.test(e) ? se(e) : e || [],
                  !1
                ).length;
              },
            });
              ...
              function (e, t) {
                se.fn[e] = function (n, r) {
                  ...
                  return (
                    ...
                    this.length > 1 &&
                      (we[e] || se.uniqueSort(i), xe.test(e) && i.reverse()),
                    this.pushStack(i)
                  );
                };
              }
                      ...
                      (function t(n) {
                        se.each(n, function (n, r) {
                          se.isFunction(r)
                            ...
                            : r && r.length && "string" !== se.type(r) && t(r);
                        });
                      })(arguments),
                      n && !t && l()),
                    this
                  ...
                  i = {
                    ...
                    then: function (t, r, i) {
                      ...
                      return se
                        .Deferred(function (e) {
                          n[0][3].add(
                            o(0, e, se.isFunction(i) ? i : s, e.notifyWith)
                          ),
                            n[1][3].add(o(0, e, se.isFunction(t) ? t : s)),
                            n[2][3].add(o(0, e, se.isFunction(r) ? r : l));
                        })
                        .promise();
                    },
                    promise: function (e) {
            ...
            se.extend({
              ...
              ready: function (e) {
                (!0 === e ? --se.readyWait : se.isReady) ||
                  ((se.isReady = !0),
                  (!0 !== e && --se.readyWait > 0) || Se.resolveWith(G, [se]));
              },
            }),
            (se.ready.then = Se.then),
            "complete" === G.readyState ||
            ("loading" !== G.readyState && !G.documentElement.doScroll)
              ? e.setTimeout(se.ready)
              : (G.addEventListener("DOMContentLoaded", c),
                  ...
                  if (
                    ...
                    for (n = a.length; n--; )
                      a[n] &&
                        ...
                        ((r = se.camelCase(r.slice(5))), d(o, r, i[r]));
              ...
              queue: function (e, t, n) {
                ...
                if (e)
                  return (
                    ...
                    n &&
                      (!r || Array.isArray(n)
                        ? (r = Ae.access(e, t, se.makeArray(n)))
                        : r.push(n)),
                    r || []
                  );
              },
          ...
          var Me = /<|&#?\w+;/;
          !(function () {
            var e = G.createDocumentFragment().appendChild(
                G.createElement("div")
              ),
            ...
            t.setAttribute("type", "radio"),
              ...
              e.appendChild(t),
              (ae.checkClone = e.cloneNode(!0).cloneNode(!0).lastChild.checked),
              (e.innerHTML = "<textarea>x</textarea>"),
              (ae.noCloneChecked = !!e.cloneNode(!0).lastChild.defaultValue);
          })();
          ...
          (se.event = {
              ...
              if (m)
                for (
                  n.handler && ((n = (o = n).handler), (i = o.selector)),
                    i && se.find.matchesSelector(_e, i),
                  ...
                  if (
                    ...
                    a &&
                      ...
                      ((f.teardown && !1 !== f.teardown.call(e, h, m.handle)) ||
                        se.removeEvent(e, p, m.handle),
                      delete l[p]);
                  } else for (p in l) se.event.remove(e, p + t[u], n, r, !0);
            ...
            dispatch: function (e) {
              ...
              if (
                ...
                for (
                  a = se.event.handlers.call(this, s, u), t = 0;
                  ...
                  for (
                    ...
                    (s.rnamespace && !s.rnamespace.test(o.namespace)) ||
                      ...
                      void 0 !==
                        (r = (
                          (se.event.special[o.origType] || {}).handle ||
                          o.handler
                        ).apply(i.elem, l)) &&
                        !1 === (s.result = r) &&
                ...
                which: function (e) {
                  ...
                  return null == e.which && We.test(e.type)
                    ? null != e.charCode
                      ? e.charCode
                      : e.keyCode
                    : !e.which && void 0 !== t && Ie.test(e.type)
                    ? 1 & t
                      ? 1
                      : 2 & t
                      ? 3
          ...
          se.extend({
            ...
            clone: function (e, t, n) {
              ...
              return (
                (a = m(s, "script")).length > 0 && y(a, !l && m(e, "script")), s
              );
            },
            ...
            se.fn.extend({
              ...
              empty: function () {
                for (var e, t = 0; null != (e = this[t]); t++)
                  1 === e.nodeType &&
                    (se.cleanData(m(e, !1)), (e.textContent = ""));
                return this;
              },
              clone: function (e, t) {
                return (
                ...
                return ke(
                  ...
                  function (e) {
                    ...
                    if (
                      "string" == typeof e &&
                      !Ue.test(e) &&
                      !Re[(Oe.exec(e) || ["", ""])[1].toLowerCase()]
                    ) {
                      e = se.htmlPrefilter(e);
                      try {
                        for (; n < r; n++)
                          1 === (t = this[n] || {}).nodeType &&
                            (se.cleanData(m(t, !1)), (t.innerHTML = e));
                        t = 0;
                      } catch (e) {}
                    }
              ...
              replaceWith: function () {
                ...
                return P(
                  ...
                  function (t) {
                    ...
                    se.inArray(this, e) < 0 &&
                      (se.cleanData(m(this)), n && n.replaceChild(t, this));
                  },
                  e
                );
              },
            ...
            se.each(
              ...
              function (e, t) {
                se.fn[e] = function (e) {
                  for (
                    var n, r = [], i = se(e), o = i.length - 1, a = 0;
                    a <= o;
                    a++
                  )
          ...
          !(function () {
            ...
            s.style &&
              ...
              (ae.clearCloneStyle = "content-box" === s.style.backgroundClip),
              (a.style.cssText =
                  ...
                  var i,
                    ...
                    a =
                      ...
                      D(
                        ...
                        t,
                        r,
                        "border-box" === se.css(e, "boxSizing", !1, o),
                        o
                      );
                  return (
                    a &&
          ...
          (se.Animation = se.extend(M, {
              ...
              function (e, t, n) {
                ...
                if ((l = !se.isEmptyObject(t)) || !se.isEmptyObject(p)) {
                  f &&
                    ...
                    null == (u = y && y.display) && (u = Ae.get(e, "display")),
                  ...
                  for (r in p)
                    l ||
                      (y
                        ...
                        : (y = Ae.access(e, "fxshow", { display: u })),
                      o && (y.hidden = !m),
                      m && g([e], !0),
                      d.done(function () {
            ...
            (function () {
              var e = G.createElement("input"),
                t = G.createElement("select").appendChild(
                  G.createElement("option")
                );
              (e.type = "checkbox"),
                (ae.checkOn = "" !== e.value),
                (ae.optSelected = t.selected),
                ((e = G.createElement("input")).value = "t"),
                (e.type = "radio"),
                (ae.radioValue = "t" === e.value);
            })();
          var ct,
            ft = se.expr.attrHandle;
          se.fn.extend({
            attr: function (e, t) {
                  ...
                  return void 0 === e.getAttribute
                    ...
                    : ((1 === o && se.isXMLDoc(e)) ||
                        (i =
                          ...
                          (se.expr.match.bool.test(t) ? ct : void 0)),
                      void 0 !== n
                        ? null === n
            ...
            se.fn.extend({
                ...
                return "boolean" == typeof t && "string" === n
                  ...
                  : this.each(function () {
                      ...
                      if ("string" === n)
                        ...
                        (void 0 !== e && "boolean" !== n) ||
                          ((t = W(this)) && Ae.set(this, "__className__", t),
                          this.setAttribute &&
                            this.setAttribute(
                              "class",
                              t || !1 === e
              ...
              hasClass: function (e) {
                var t,
                  ...
                  r = 0;
                for (t = " " + e + " "; (n = this[r++]); )
                  if (1 === n.nodeType && (" " + _(W(n)) + " ").indexOf(t) > -1)
                    return !0;
                return !1;
              },
            });
                ...
                if (arguments.length)
                  return (
                    ...
                    this.each(function (n) {
                      var i;
                      1 === this.nodeType &&
                        (null == (i = r ? e.call(this, n, se(this).val()) : e)
                          ? (i = "")
                          : "number" == typeof i
                          ? (i += "")
                          : Array.isArray(i) &&
                ...
                select: {
                  ...
                  set: function (e, t) {
                    for (
                      ...
                      ((r = i[a]).selected =
                        se.inArray(se.valHooks.option.get(r), o) > -1) &&
                        (n = !0);
              ...
              if (
                ...
                for (o = 0; (a = d[o++]) && !t.isPropagationStopped(); )
                  (t.type = o > 1 ? l : f.bindType || p),
                    (c =
                      (Ae.get(a, "events") || {})[t.type] &&
                      Ae.get(a, "handle")) && c.apply(a, n),
                    (c = u && a[u]) &&
                      c.apply &&
                      Ee(a) &&
              ...
              se.each({ focus: "focusin", blur: "focusout" }, function (e, t) {
                ...
                se.event.special[t] = {
                  ...
                  teardown: function () {
                    ...
                    i
                      ? Ae.access(r, t, i)
                      : (r.removeEventListener(e, n, !0), Ae.remove(r, t));
                  },
                };
              });
          var mt = e.location,
          ...
          (qt.href = mt.href),
              ...
              ajax: function (t, n) {
                function r(t, n, r, s) {
                  ...
                  c ||
                    ...
                    (T.statusText = (n || C) + ""),
                    u
                      ? y.resolveWith(g, [d, C, T])
                      : y.rejectWith(g, [T, C, p]),
                    T.statusCode(b),
                    (b = void 0),
                    f &&
                ...
                (f = se.event && h.global) &&
                  ...
                  h.ifModified &&
                    ...
                    se.etag[o] &&
                      T.setRequestHeader("If-None-Match", se.etag[o])),
                ...
                if (
                  ...
                  if (
                    ((T.readyState = 1), f && m.trigger("ajaxSend", [T, h]), c)
                  )
                    return T;
                  h.async &&
                    h.timeout > 0 &&
            ...
            se.each(["get", "post"], function (e, t) {
              se[t] = function (e, n, r, i) {
                return (
                  se.isFunction(n) && ((i = i || r), (r = n), (n = void 0)),
                  se.ajax(
                    se.extend(
          ...
          (ae.cors = !!Dt && "withCredentials" in Dt),
            (ae.ajax = Dt = !!Dt),
            se.ajaxTransport(function (t) {
              var n, r;
              if (ae.cors || (Dt && !t.crossDomain))
                return {
                  send: function (i, o) {
                    var a,
                      s = t.xhr();
          ...
          se.ajaxSetup({
            ...
            se.ajaxPrefilter("json jsonp", function (t, n, r) {
              ...
              if (s || "jsonp" === t.dataTypes[0])
                return (
                  (i = t.jsonpCallback = se.isFunction(t.jsonpCallback)
                    ? t.jsonpCallback()
                    : t.jsonpCallback),
                  s
              ...
              return (
                t ||
                  (ae.createHTMLDocument
                    ? (((r = (t = G.implementation.createHTMLDocument(
                        ""
            ...
            (se.fn.load = function (e, t, n) {
              var r,
                ...
                s = e.indexOf(" ");
              return (
                s > -1 && ((r = _(e.slice(s))), (e = e.slice(0, s))),
                se.isFunction(t)
                  ? ((n = t), (t = void 0))
                ...
                a.length > 0 &&
                  se
                    ...
                    .done(function (e) {
                      (o = arguments),
                        a.html(
                          r ? se("<div>").append(se.parseHTML(e)).find(r) : e
                        );
                    })
                    .always(
                      n &&
            ...
            (se.offset = {
              setOffset: function (e, t, n) {
                ...
                "static" === u && (e.style.position = "relative"),
                  ...
                  se.isFunction(t) && (t = t.call(e, n, se.extend({}, s))),
            ...
            se.each(["top", "left"], function (e, t) {
              se.cssHooks[t] = L(ae.pixelPosition, function (e, n) {
                if (n)
                  return (
                    (n = j(e, t)), Ze.test(n) ? se(e).position()[t] + "px" : n
                  );
              });
            }),
          ...
          var r = (function (e, t) {
            ...
            var A = (function () {
                var a,
                    ...
                    if ((d = r.loadMode) && R < 8 && (e = m.length)) {
                      ...
                      for (; o < e; o++)
                        if (m[o] && !m[o]._lazyRace)
                          if (O)
                            if (
                              (((h = m[o].getAttribute("data-expand")) &&
                                (f = 1 * h)) ||
                                (f = $),
                              g !== f &&
                                ((C = innerWidth + f * H),
                  ...
                  B = k(I),
                  X = function (e) {
                    m(e.target, r.loadedClass),
                      y(e.target, r.loadingClass),
                      v(e.target, Y),
                  ...
                  Q = S(function (e, t, n, i, o) {
                    ...
                    (p = b(e, "lazybeforeunveil", t)).defaultPrevented ||
                      ...
                      g &&
                        ...
                        m(e, r.loadingClass),
                        v(e, Y, !0)),
                      d && h.call(u.getElementsByTagName("source"), G),
                      s
                ...
                return {
                  _: function () {
                    (p = o.now()),
                      ...
                      s("resize", B, !0),
                      e.MutationObserver
                        ? new MutationObserver(B).observe(i, {
                            childList: !0,
                            subtree: !0,
                            attributes: !0,
                          })
                        : (i.addEventListener("DOMNodeInserted", B, !0),
                          i.addEventListener("DOMAttrModified", B, !0),
                          setInterval(B, 999)),
                      s("hashchange", B, !0),
                      [
                        "focus",
                      ...
                      /d$|^c/.test(t.readyState)
                        ...
                        : (s("load", Z),
                          ...
                          l(Z, 2e4)),
                      n.elements.length ? (I(), T._lsFlush()) : B();
                  },
                  checkElems: B,
                  unveil: J,
                };
              ...
              P = (function () {
                var e,
                  ...
                  i = function (e, t, r) {
                    ...
                    o &&
                      ((r = C(e, o, r)),
                      (i = b(e, "lazybeforesizes", { width: r, dataAttr: !!t }))
                        .defaultPrevented ||
                        ((r = i.detail.width) &&
                          r !== e._lazysizesWidth &&
                          n(e, o, i, r)));
        ...
        !(function (n, r) {
          ...
          function r(e, n) {
            if (!a[e]) {
              ...
              n ? ((r.rel = "stylesheet"), (r.href = e)) : (r.src = e),
                (a[e] = !0),
                (a[r.src || r.href] = !0),
              ...
              function (e) {
                if (e.detail.instance == n) {
                  ...
                  e.defaultPrevented ||
                    ...
                    (t = e.target.getAttribute("data-link")) && r(t, !0),
                    (t = e.target.getAttribute("data-script")) && r(t),
                    (t = e.target.getAttribute("data-require")) &&
                      (n.cfg.requireJs ? n.cfg.requireJs([t]) : r(t)),
                    (a = e.target.getAttribute("data-bg")) &&
                      ((e.detail.firesLoad = !0),
                      i(a, function () {
                        (e.target.style.backgroundImage =
                          "url(" + (o.test(a) ? JSON.stringify(a) : a) + ")"),
                          (e.detail.firesLoad = !1),
                          n.fire(e.target, "_lazyloaded", {}, !0, !0);
                      })),
                    (s = e.target.getAttribute("data-poster")) &&
                      ((e.detail.firesLoad = !0),
                      i(s, function () {
                        (e.target.poster = s),
                          (e.detail.firesLoad = !1),
        ...
        !(function (e) {
            ...
            (n.isWindow = function (e) {
              ...
              (n.each = function (e, n, r) {
                ...
                if (r) {
                  ...
                  for (i in e)
                    if (e.hasOwnProperty(i) && !1 === n.call(e[i], i, e[i]))
                      break;
                return e;
              }),
                  ...
                  if ((o = arguments[l]))
                    for (i in o)
                      o.hasOwnProperty(i) &&
                        ((e = s[i]),
                        s !== (r = o[i]) &&
                          (c && r && (n.isPlainObject(r) || (t = n.isArray(r)))
                            ? (t
          ...
          (function (e) {
            ...
            return (function (e, t, n, r) {
              function i(e) {
                return (
                  v.isWrapped(e) ? (e = m.call(e)) : v.isNode(e) && (e = [e]), e
                );
              }
              function o(e) {
              ...
              function l(e, n, r, i) {
                ...
                function c(t) {
                  for (var n = 0, i = 1, o = m - 1; i !== o && x[i] <= t; ++i)
                    n += y;
                  ...
                  v.isString(e)
                    ...
                    : (n =
                        v.isArray(e) && 1 === e.length
                          ...
                          ? T.apply(null, e.concat([t]))
                          : !(!v.isArray(e) || 4 !== e.length) &&
                            l.apply(null, e)),
                  !1 === n &&
                    (n = C.Easings[C.defaults.easing] ? C.defaults.easing : w),
                  n
                );
              }
              function c(e) {
                    ...
                    if (C.State.calls[i]) {
                      ...
                      for (
                        ...
                        if (o(A)) {
                          ...
                          l.visibility !== r &&
                            "hidden" !== l.visibility &&
                            S.setPropertyValue(A, "visibility", l.visibility);
                          for (var N in k)
                            if (k.hasOwnProperty(N) && "element" !== N) {
                              var j,
                                L = k[N],
                                q = v.isString(L.easing)
                                  ? C.Easings[L.easing]
                                  : L.easing;
                              ...
                              if (((L.currentValue = j), "tween" === N)) m = j;
                                ...
                                S.Hooks.registered[N] &&
                                  (S.Normalizations.registered[H]
                                    ...
                                    : (o(A).rootPropertyValueCache[H] = V[1])),
                                  "transform" === V[0] && (P = !0);
                              }
                            }
                          l.mobileHA &&
                            o(A).transformCache.translate3d === r &&
                            ((o(A).transformCache.translate3d =
                              "(0px, 0px, 0px)"),
                            (P = !0)),
                            P && S.flushTransformCache(A);
                        }
                      }
                      l.display !== r &&
                        "none" !== l.display &&
                        (C.State.calls[i][2].display = !1),
                        l.visibility !== r &&
                          "hidden" !== l.visibility &&
                          (C.State.calls[i][2].visibility = !1),
                        l.progress &&
                          l.progress.call(
                            a[1],
                            a[1],
              ...
              function f(e, t) {
                ...
                for (
                  ...
                  t ||
                    a.loop ||
                    ("none" === a.display &&
                      S.setPropertyValue(f, "display", a.display),
                    "hidden" === a.visibility &&
                      S.setPropertyValue(f, "visibility", a.visibility));
                  var p = o(f);
                  if (
                    !0 !== a.loop &&
                    (d.queue(f)[1] === r ||
                    ...
                    d.each(S.Lists.transforms3D, function (e, t) {
                      ...
                      p.transformCache[t] !== r &&
                        new RegExp("^\\(" + n + "[^.]").test(i) &&
                        ((h = !0), delete p.transformCache[t]);
                    }),
                      a.mobileHA &&
                        ((h = !0), delete p.transformCache.translate3d),
                      h && S.flushTransformCache(f),
                      S.Values.removeClass(f, "velocity-animating");
                  }
                  ...
                  s && !0 !== a.loop && s(i),
                    p &&
                      !0 === a.loop &&
                      !t &&
                      (d.each(p.tweensContainer, function (e, t) {
                        if (
                          /^rotate/.test(e) &&
                      ...
                      C(f, "reverse", { loop: !0, delay: a.delay })),
                ...
                var S = (C.CSS = {
                  ...
                  Hooks: {
                    ...
                    fixColors: function (e) {
                      return e.replace(
                        /(rgba?\(\s*)?(\b[a-z]+\b)/g,
                        function (e, t, n) {
                          return S.Lists.colorNames.hasOwnProperty(n)
                            ? (t || "rgba(") +
                                S.Lists.colorNames[n] +
                                (t ? "" : ",1)")
                            : t + n;
                        }
                      );
                    ...
                    injectValue: function (e, t, n) {
                      ...
                      if (r) {
                        var i,
                          ...
                          a = r[1];
                        return (
                          (n = S.Hooks.cleanRootPropertyValue(o, n)),
                  ...
                  Normalizations: {
                    registered: {
                      clip: function (e, t, n) {
                        switch (e) {
                          ...
                          case "extract":
                            var r;
                            return (r = S.RegEx.wrappedValueAlreadyExtracted.test(
                              n
                            )
                              ? n
                              : (r = n.toString().match(S.RegEx.valueUnwrap))
                              ? r[1].replace(/,(\s+)?/g, " ")
                              : n);
                          case "inject":
                            return "rect(" + n + ")";
                    ...
                    register: function () {
                      function e(e, t, n) {
                        if (
                          ("border-box" ===
                            S.getPropertyValue(t, "boxSizing")
                              .toString()
                              .toLowerCase()) ===
                          (n || !1)
                        ) {
                          ...
                          S.Normalizations.registered[e] = function (t, n, i) {
                            switch (t) {
                              ...
                              case "extract":
                                var o;
                                if (
                                  S.RegEx.wrappedValueAlreadyExtracted.test(i)
                                )
                                  o = i;
                                else {
                                  var a,
                                  ...
                                  /^[A-z]+$/i.test(i)
                                    ? (a = s[i] !== r ? s[i] : s.black)
                                    : S.RegEx.isHex.test(i)
                                    ? (a =
                                        "rgb(" +
                                        S.Values.hexToRgb(i).join(" ") +
                                        ")")
                      ...
                      (S.Normalizations.registered.innerWidth = t("width", !0)),
                        (S.Normalizations.registered.innerHeight = t(
                          "height",
                          !0
                        )),
                  ...
                  Names: {
                    ...
                    SVGAttribute: function (e) {
                      ...
                      return (
                        (p || (C.State.isAndroid && !C.State.isChrome)) &&
                          (t += "|transform"),
                    ...
                    prefixCheck: function (e) {
                      ...
                      for (
                        ...
                        if (
                          ...
                          v.isString(C.State.prefixElement.style[i]))
                        )
                  ...
                  Values: {
                    ...
                    addClass: function (e, t) {
                      if (e)
                        ...
                        else if (v.isString(e.className))
                          e.className += (e.className.length ? " " : "") + t;
                        else {
                          var n =
                            e.getAttribute(p <= 7 ? "className" : "class") ||
                            "";
                  ...
                  getPropertyValue: function (e, n, i, a) {
                      ...
                      if (p <= 8) i = d.css(e, n);
                        ...
                        if (!a) {
                          if (
                            ...
                            var c =
                              e.offsetHeight -
                              (parseFloat(
                                S.getPropertyValue(e, "borderTopWidth")
                              ) || 0) -
                              (parseFloat(
                                S.getPropertyValue(e, "borderBottomWidth")
                              ) || 0) -
                              (parseFloat(
                                S.getPropertyValue(e, "paddingTop")
                              ) || 0) -
                              (parseFloat(
                                S.getPropertyValue(e, "paddingBottom")
                              ) || 0);
                            return u(), c;
                          }
                          if (
                            ...
                            var f =
                              e.offsetWidth -
                              (parseFloat(
                                S.getPropertyValue(e, "borderLeftWidth")
                              ) || 0) -
                              (parseFloat(
                                S.getPropertyValue(e, "borderRightWidth")
                              ) || 0) -
                              (parseFloat(
                                S.getPropertyValue(e, "paddingLeft")
                              ) || 0) -
                              (parseFloat(
                                S.getPropertyValue(e, "paddingRight")
                              ) || 0);
                            return u(), f;
                          }
                        }
                        ...
                        (h =
                          o(e) === r
                            ...
                            : o(e).computedStyle
                            ? o(e).computedStyle
                            : (o(e).computedStyle = t.getComputedStyle(
                                e,
                                null
                              ))),
                    ...
                    if (S.Hooks.registered[n]) {
                      var u = n,
                        c = S.Hooks.getRoot(u);
                      i === r &&
                        (i = S.getPropertyValue(e, S.Names.prefixCheck(c)[0])),
                        S.Normalizations.registered[c] &&
                          (i = S.Normalizations.registered[c]("extract", e, i)),
                        (l = S.Hooks.extractValue(u, i));
                    } else if (S.Normalizations.registered[n]) {
                      var f, h;
                      "transform" !==
                        (f = S.Normalizations.registered[n]("name", e)) &&
                        ((h = s(e, S.Names.prefixCheck(f)[0])),
                        S.Values.isCSSNullValue(h) &&
                          S.Hooks.templates[n] &&
                          (h = S.Hooks.templates[n][1])),
                        (l = S.Normalizations.registered[n]("extract", e, h));
                    }
                    if (!/^[\d-]/.test(l)) {
                      var g = o(e);
                  ...
                  setPropertyValue: function (e, n, r, i, a) {
                    ...
                    if ("scroll" === n)
                      ...
                      S.Normalizations.registered[n] &&
                      "transform" === S.Normalizations.registered[n]("name", e)
                    )
                      ...
                      if (
                        (S.Normalizations.registered[n] &&
                          ((r = S.Normalizations.registered[n]("inject", e, r)),
                        ...
                        var c = o(e);
                        c && c.isSVG && S.Names.SVGAttribute(n)
                          ? e.setAttribute(n, r)
                          : (e.style[s] = r);
                      }
                      C.debug >= 2 &&
                  ...
                  flushTransformCache: function (e) {
                    ...
                    if (
                      ...
                      d.each(o(e).transformCache, function (n) {
                        if (
                          ((a = o(e).transformCache[n]),
                          "transformPerspective" === n)
                        )
                          return (s = a), !0;
                        9 === p && "rotateZ" === n && (n = "rotate"),
                          (t += n + a + " ");
                      }),
                        s && (t = "perspective" + s + " " + t);
                    }
                  ...
                  (C.hook = function (e, t, n) {
                    ...
                    return (
                      ...
                      d.each(e, function (e, i) {
                        if ((o(i) === r && C.init(i), n === r))
                          a === r && (a = S.getPropertyValue(i, t));
                        else {
                          var s = S.setPropertyValue(i, t, n);
                          "transform" === s[0] && C.CSS.flushTransformCache(i),
                            (a = s);
                        }
                      }),
                      a
                ...
                var k = function () {
                  ...
                  if (
                    ...
                    if (
                      ...
                      w = {};
                      for (var N = g + 1; N < arguments.length; N++)
                        v.isArray(arguments[N]) ||
                        (!/^(fast|normal|slow)$/i.test(arguments[N]) &&
                          !/^\d/.test(arguments[N]))
                          ? v.isString(arguments[N]) || v.isArray(arguments[N])
                            ? (w.easing = arguments[N])
                            : v.isFunction(arguments[N]) &&
                              (w.complete = arguments[N])
                          : (w.duration = arguments[N]);
                    }
                    var j;
                    switch (b) {
                      case "scroll":
                                ...
                                d.each(m, function (n, r) {
                                  if (r === i)
                                    if (
                                      ...
                                      ("finish" !== b && "finishAll" !== b) ||
                                        (t[2].duration = 1);
                                });
                              });
                          }),
                          "stop" === b &&
                            (d.each(q, function (e, t) {
                              f(t, !0);
                            }),
                      ...
                      default:
                        if (!d.isPlainObject(b) || v.isEmptyObject(b)) {
                            ...
                            return (
                              ...
                              d.each(m, function (e, t) {
                                parseFloat(l.stagger)
                                  ? (l.delay = D + parseFloat(l.stagger) * e)
                                  : v.isFunction(l.stagger) &&
                                    (l.delay = D + l.stagger.call(t, e, A)),
                                  l.drag &&
                                    ((l.duration =
                                      parseFloat(F) ||
                          ...
                          return (
                            E.promise
                              ? E.rejecter(new Error(H))
                              : t.console && console.log(H),
                            e()
                          );
                        }
                        j = "start";
                    ...
                    d.each(m, function (e, i) {
                        ...
                        (function (e, i) {
                          function a(a) {
                            ...
                            if ("scroll" === j) {
                              ...
                              l.container
                                ? v.isWrapped(l.container) ||
                                  v.isNode(l.container)
                                  ? ((l.container =
                                      l.container[0] || l.container),
                                    (T =
                                      (g = l.container["scroll" + k]) +
                                      d(e).position()[k.toLowerCase()] +
                                      N))
                                  : (l.container = null)
                                : ((g =
                                    C.State.scrollAnchor[
                                      C.State["scrollProperty" + k]
                                    ]),
                                  (x =
                                    C.State.scrollAnchor[
                                      C.State[
                              ...
                              if (!p.tweensContainer)
                                return void d.dequeue(e, l.queue);
                              "none" === p.opts.display &&
                                (p.opts.display = "auto"),
                                "hidden" === p.opts.visibility &&
                              ...
                              for (var L in h)
                                if (h.hasOwnProperty(L) && "element" !== L) {
                                  ...
                                  (h[L].startValue = h[L].currentValue =
                                    h[L].endValue),
                                    (h[L].endValue = q),
                                    v.isEmptyObject(w) ||
                                      (h[L].easing = l.easing),
                              ...
                              var F = function (t, n) {
                                  var r, o, a;
                                  return (
                                    v.isFunction(t) && (t = t.call(e, i, A)),
                                    v.isArray(t)
                                      ? ((r = t[0]),
                                        (!v.isArray(t[1]) &&
                                          /^[\d-]/.test(t[1])) ||
                                        v.isFunction(t[1]) ||
                                        S.RegEx.isHex.test(t[1])
                                          ? (a = t[1])
                                          : (v.isString(t[1]) &&
                                              !S.RegEx.isHex.test(t[1]) &&
                                              C.Easings[t[1]]) ||
                                      ...
                                      : (r = t),
                                    n || (o = o || l.easing),
                                    v.isFunction(r) && (r = r.call(e, i, A)),
                                    v.isFunction(a) && (a = a.call(e, i, A)),
                                    [r || 0, o, a]
                                  );
                                },
                                D = function (i, o) {
                                  ...
                                  if (
                                    (p && p.isSVG) ||
                                    "tween" === u ||
                                    !1 !== S.Names.prefixCheck(u)[1] ||
                                    S.Normalizations.registered[u] !== r
                                  ) {
                                    ((l.display !== r &&
                                      null !== l.display &&
                                      "none" !== l.display) ||
                                      ...
                                      l._cacheValues && h && h[i]
                                        ? (y === r &&
                                            (y = h[i].endValue + h[i].unitType),
                                          (c = p.rootPropertyValueCache[u]))
                                        : S.Hooks.registered[i]
                                        ? y === r
                                          ? ((c = S.getPropertyValue(e, u)),
                                            (y = S.getPropertyValue(e, i, c)))
                                          : (c = S.Hooks.templates[u][1])
                                        : y === r &&
                                          (y = S.getPropertyValue(e, i));
                                    var b,
                                      x,
                                      w,
                                      T = !1,
                                    ...
                                    if (
                                      ...
                                      for (
                                        y = S.Hooks.fixColors(y),
                                          g = S.Hooks.fixColors(g);
                                        E < y.length && A < g.length;
                                        ...
                                        s =
                                          ...
                                          (function () {
                                            var r = {
                                              ...
                                              i =
                                                r.position === z.lastPosition &&
                                                r.myParent === z.lastParent,
                                              o = r.fontSize === z.lastFontSize;
                                            (z.lastParent = r.myParent),
                                              (z.lastPosition = r.position),
                                              (z.lastFontSize = r.fontSize);
                                            var a = {};
                                            if (o && i)
                                    ...
                                    if (S.RegEx.isHex.test(R)) {
                                      for (
                                        var W = ["Red", "Green", "Blue"],
                                          I = S.Values.hexToRgb(R),
                                          B = _ ? S.Values.hexToRgb(_) : r,
                                          X = 0;
                                        X < W.length;
                                        X++
                                      ) {
                            ...
                            f.element &&
                              ...
                              P === A - 1
                                ? (C.State.calls.push([
                                  ...
                                  !1 === C.State.isTicking &&
                                    ((C.State.isTicking = !0), c()))
                                : P++);
                          }
                          var s,
                            l = d.extend({}, C.defaults, w),
                            f = {};
                          switch (
                            (o(e) === r && C.init(e),
                            parseFloat(l.delay) &&
                              !1 !== l.queue &&
                              d.queue(e, l.queue, function (t) {
                          ...
                          if (
                            ...
                            l.begin &&
                              !v.isFunction(l.begin) &&
                              (l.begin = null),
                            l.progress &&
                              !v.isFunction(l.progress) &&
                              (l.progress = null),
                            l.complete &&
                              !v.isFunction(l.complete) &&
                              (l.complete = null),
                            l.display !== r &&
                              null !== l.display &&
                            ...
                            d.queue(e, l.queue, function (e, t) {
                              if (!0 === t)
                                return E.promise && E.resolver(m), !0;
                      ...
                      ((l = d.extend({}, C.defaults, w)).loop = parseInt(
                        l.loop,
                        10
                      ));
                    var O = 2 * l.loop - 1;
